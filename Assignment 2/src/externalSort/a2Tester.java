...
public class a2Tester {
	...
	public static void main(String[] args) {
		...
		final int MEMSIZE = 15;
		final int TAPESIZE = 60;
...
//TO TEST DO RUN  
        int j;
        for (j=0; MEMSIZE*Math.pow(2, j) < TAPESIZE; j++){
    		if (j%2==0)
    			tapeSorter.doRun(t3, t4, t1, t2, j);
    		else
    			tapeSorter.doRun(t1, t2, t3, t4, j);
    	};       
       System.out.println("j = " + j);
       if (j%2==0){			//sorted data ends up on drive 3
    	   t1.reset();
    	   t3.reset();
